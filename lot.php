...
<?php 
  require ('helpers.php');
  $id = $_GET['id'];
  if(in_array($id, $_GET) == false) {
    http_response_code(404);
    echo "Ошибка ".http_response_code();
    exit();
  }
    ...
    <section class="lot-item container">
      ...
      <div class="lot-item__content">
        ...
        <div class="lot-item__right">
          ...
          <?php $exp_time = count_date($lot['expiration_date']); ?>
            <div class="lot-item__timer timer<?= ($exp_time['hours'] == 0) ? " timer--finishing" : ""; ?>">
